...
{    
  ...
  if(SystemCoreClock == 48000000) SetSysClock();
}
...
//  表示注释的库函数    （ Bits 16:15 PLLSRC[1:0]: PLL input clock source ）内部HSI
//	没法设置01: HSI/PREDIV selected as PLL input clock 只能设置 00: HSI/2 selected as PLL input clock
//	所以倍频12倍 12*8/2=48mhz
